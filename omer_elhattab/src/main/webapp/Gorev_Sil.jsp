...
<main class="d-flex flex-nowrap">
    ...
    >
        ...
        <form style="text-align: center"  action="gorevler-sil" method="post">
            <div class="form-group">
                <label for="gorevsill">Silincek gorevi seçiniz </label>
                <select class="form-control" id="gorevsill" name="silinecek" style="    text-align: center;
                    width: 35%;
                    position: relative;
                    left: 33%;
                    margin-top: 10px;
            ...
            <button    type="submit" class="btn btn-primary text-white" style="background: linear-gradient(to top left, #33ccff 13%, #ff66cc 89%);width: 15%; border: white"
            ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
                <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"/>
                <i class="bi bi-x-lg">sil</i>
                </svg> </button>
