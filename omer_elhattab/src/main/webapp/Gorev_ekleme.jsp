...
<head>
    ...
    <style>
        ...
        #list-main{
            ...
            padding-top: 10px;
            padding-bottom: 10px;
            background: linear-gradient(to bottom right, #0066ff 17%, #ff33cc 100%);
...
<main class="d-flex flex-nowrap">
    ...
    <div
            ...
            style="width: 76.92%; right: 0px; height: 100%; position: absolute"
    >
        <h2 id="list-main" >görev ekleme</h2>

        <form action="gorev_ekleS" method="post">

            <div class="form-group">
                <label for="gorevicin">Görev adi</label>
                <input type="text" name="gorev_adi" class="form-control" id="gorevicin" >
            </div>
            ...
            <div class="form-group">
                <label for="acıklama">Görev acıklaması  </label>
                <input type="text" class="form-control" name="gorev_acıklama" id="acıklama">
