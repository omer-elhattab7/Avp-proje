...
<head>
    ...
    <style>
        ...
        #Sil_list{
            ...
            color: black;
            font-weight: 500;
            background: linear-gradient(to top left, #66ffff 13%, #ffccff 89%);
            font-size: 19px;
            border-radius: 20px;
            padding-top: 0.5%;
            box-shadow:rgb(153, 255, 255,0.4) 0px 50px 100px -20px, rgb(255, 102, 255,0.4) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;
        }
...
<main class="d-flex flex-nowrap">
    ...
    >
        ...
        <table class="table table-striped table-sm"  id="elmaTable">
            <thead>
            <tr>
            ...
            <c:forEach var="görevler" items="${gorevler}">
                <tr>
                    <td>
                        <c:if test="${görevler.gorev_tarihi gt formattedDate }">
                            ${görevler.gorev_tarihi}
                        </c:if>
                        <c:if test="${görevler.gorev_tarihi lt formattedDate }">
                            <div style="background-color:#e71d36; border-radius: 10px;">${görevler.gorev_tarihi}</div>
                        </c:if>
                    </td>
                    <td>
                            ${görevler. gorev_adi}
                    ...
                    <td>
                            ${görevler.gorev_acıklama}
                    </td>
                    <td>
                    <c:choose>
                        <c:when test="${görevler.gorev_dercesi=='Onemli'}">
                            <div style="background-color:#e71d36; border-radius: 10px;">Yüksek</div>
                            <br />
                        </c:when>
                        <c:when test="${görevler.gorev_dercesi=='orta'}">
                            <div style="background-color:#ffba08; border-radius: 10px;">Orta</div>
                            <br />
                        </c:when>
                        <c:otherwise>
                            <div style="background-color: #55a630; border-radius: 10px;">Düşük</div>
                            <br />
                        </c:otherwise>
                    </c:choose>
                 </td>
        ...
        <div id="Sil_list"> <i class="bi bi-x-lg">yukarda alınan liste emanları tarihi en yeniden eskiye doğru sıralanmaktadır</i></div>
